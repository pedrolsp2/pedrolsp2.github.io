...
<header id="header">
		...
		<nav id="nav">
			...
			<ul class="menu" role="menu">
				...
				<li><a href="page/login/index.php">Login</a></li>
			</ul>
	...
	<div class="second-nave">
        ...
        <a href="index.html" id="icon-menu-inferior">
				<div class="second-item ativo left">
					<img src="images/home.svg" alt="Inicio">
				</div>
			</a>

			<a href="page/login/index.php" id="icon-menu-inferior">
				<div class="second-item">
					<img src="images/login.svg" alt="Login">
				</div>
			</a>

			<div class="second-item" id="second-logo">
			...
			<a href="partida.html" id="icon-menu-inferior">
				<div class="second-item">
					<img src="images/prereserva.svg" alt="Pre Reserva">
				</div>
			</a>

			<a href="quadra.php" id="icon-menu-inferior">
				<div class="second-item rigth">
					<img src="images/quadra.svg" alt="Visu Quadra">
				</div>
			</a>
